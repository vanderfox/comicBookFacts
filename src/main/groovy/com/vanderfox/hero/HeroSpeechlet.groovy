...
public class HeroSpeechlet implements Speechlet {
    ...
    private SpeechletResponse getWelcomeResponse(Session session) {
        String speechText = "Welcome to Hero Quiz.  I will ask you 10 questions to test your superhero knowledge.  Say the number of the answer that you think is correct.  Say repeat question anytime you need to hear the question again.  You can end the game at any time by saying cancel or stop.  Of course, you can always say help at any time.  OK, let's get started.\n\n";
